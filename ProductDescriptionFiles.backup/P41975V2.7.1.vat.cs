...
{
    public class P41975V2_7_1 : WizardScriptBase3
    {
        ...
        private void init()
        {
            ...
            //Create LAN port
            ComponentData Lan = VehicleApplication2.CreateDevice("LAN", "LAN", VehicleApplication2.ApplicationName, "CVC600", true);
        }
        #endregion
        ...
        public override void SetNavigationType(string navigationType)
        {
            ...
            ComponentData laserNavigator, ReflectorInit, device;
            ...
            if (BUILTIN_SDIO_DCT != "" && VehicleApplication2.OkToAddComponent("SDIO"))
            {
                ...
                canDevice = VehicleApplication2.CreateCanDevice("CVC600",
            ...
            try
            {
                ...
                if (reflectorChoosen)
                {
                    laserNavigator = VehicleApplication2.CreateComponent("LaserNavigator", "LaserNavigator");
                    laserNavigator.AddReference("Scanner");  // Create empty sensor list
                ...
                if (vechileNavigatorNedeed)
                {
                    ...
                    if (reflectorChoosen)
                    {
                        vehicleNavigator.AddReference("Navigators", "LaserNavigator");
        ...
        public string CreateServo(string model, bool isSteerServo, bool useAllOk, ComponentData vehicle)
        {
            ...
            CanComponentData canDevice = VehicleApplication2.CreateCanDevice("CVC600",
                                                                            VehicleApplication2.CANBusName,
                                                                            getdriveDCT(model),
                                                                            templateParameters, true);
